...
/*ai_random_move(-delta X,-delta Y,-move_stac,+row,-collumn)*/
...
/*make_list_targ(+X,+Y,+Length,+B,+Target,+Move_Stac,-Result)*/
...
/*make_mat_targ(+X,+Y,+B,+Target,+Move_Stac,-Result))*/
...
/*treat(+All_moves,+Xi,+Yi,+Active player,+Waiting player,+B,-result)*/
treat([],_,_,_,_,_,[]).
...
/*ai_greedy_move([[+Xi,+Yi,_]|_],,+Active player,+Wainting player,+Board,-Dx,-Dy,-Move Stac)*/
